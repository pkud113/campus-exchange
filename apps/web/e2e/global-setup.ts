...
('${profileIds.campusModerator}','${campusA}','moderator','${profileIds.platformAdministrator}'),('${profileIds.campusAdministrator}','${campusA}','admin','${profileIds.platformAdministrator}'),('${profileIds.platformModerator}','${campusB}','student',null),('${profileIds.platformAdministrator}','${campusB}','student',null);
