...
export function SocialFeed({ organizationId = null }: { organizationId?: string | null }) {
  ...
  return <div className="social-layout">
    <SurfaceCard className="social-composer" id="composer">
      <form onSubmit={publish}>
        <label htmlFor="social-body">{organizationId ? "Publish an organization update" : "Share an update"}</label>
